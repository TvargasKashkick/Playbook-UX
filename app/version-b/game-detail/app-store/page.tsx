    ...
    <div className="flex flex-col w-full max-w-[390px] mx-auto bg-white min-h-screen relative overflow-hidden">
      ...
      <div className="flex-1 overflow-y-auto pb-[83px]">
        ...
        <div className="px-4 flex flex-col gap-[5px] pb-[5px]">
          ...
          {/* Back — routes to /version-b/game-detail */}
          <button
            onClick={() => router.push('/version-b/game-detail?tab=missions')}
          ...
          <div className="flex items-start justify-between shrink-0">
            ...
            <div className="flex flex-col gap-[10px] w-[205px]">
              ...
              <div className="flex items-center justify-between w-full">
                {/* Get button — routes to /version-b/game-detail/gameplay */}
                <button onClick={() => router.push('/version-b/game-detail/gameplay')} className="h-[28px] w-[72px] rounded-[25px] bg-[#3478f6] flex items-center justify-center active:opacity-75">
