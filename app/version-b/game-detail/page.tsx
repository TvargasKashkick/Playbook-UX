    ...
    <div className="flex flex-col w-full max-w-[390px] mx-auto bg-white min-h-screen">
      ...
      <header className="sticky top-0 z-20 bg-[#faf2fc] flex items-center justify-between px-4 h-14 shrink-0">
        ...
        <div className="flex items-center gap-4">
          ...
          {/* Close button — routes back to /version-b */}
          <button onClick={() => router.push('/version-b')} className="relative h-6 w-6 flex items-center justify-center active:opacity-75">
            <span className="absolute -inset-2.5" />
      ...
      {activeTab === 'missions' && (
        <div className="flex flex-col bg-white">
          ...
          <div className="bg-[#faf2fc] p-4 flex flex-col gap-3 shrink-0">
            ...
            <button onClick={() => router.push('/version-b/game-detail/app-store')} className="w-full bg-[#0c7a20] rounded-[100px] flex items-center justify-center gap-2 pl-5 pr-[9px] py-3 overflow-hidden active:opacity-75">
