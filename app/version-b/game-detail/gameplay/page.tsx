  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        {/* Back — bottom-left, routes to /version-b/game-detail/app-store */}
        <button
          onClick={() => router.push('/version-b/game-detail/app-store')}
        ...
        {/* Continue — bottom-right, routes to /version-b?downloaded=true */}
        <button
          onClick={() => router.push('/version-b?downloaded=true')}
          className="active:opacity-75"
          style={{
